...
export const aboutData = {
    ...
    desc1: "來自國際四大會計師事務所組成的會計師團隊，結合大型事務所經驗與財稅規劃專業，提供量身打造、最貼近企業需求的建議。",
...
export const teamData = [
    ...
    },
    {
        ...
        role: "總顧問",
        image: team3,
        description: "盧文聰現任丞起聯合會計師事務所榮譽顧問，擁有國立臺灣大學商學學位，並曾修習科技法律課程。結合其財務專業與法規敏感度，深具跨領域整合能力，專精於金融業風險管理（Basel II）、內部控制制度設計、營運流程優化及財務功能重整，能長期協助企業提升治理效能與合規韌性。",
        description2: "除擔任榮譽顧問外，盧顧問曾任臺灣證券交易所 XBRL 委員，現為跨境創新協會理事長，長期深耕金融科技與監理科技（RegTech）領域。憑藉其在制度建構與產業創新推動方面的豐富歷練，結合財務專業背景與對財務資訊透明化及跨境合作的深刻洞察，盧顧問能協助企業在數位轉型與監理挑戰中，制定具前瞻性且可落實的策略，進而強化治理效能並提升合規韌性。",
        education: [
            "台灣大學商學研究所碩士",
            "東吳大學法律研究科技法律組"
        ],
