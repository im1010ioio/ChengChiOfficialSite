import{h as a,c as l,s as o,a as s,t as i,b as d,H as n,F as c,d as r,e as x}from"./loading-DG0MgPe8.js";function m(){return`
    <div id="top"></div>
  ...
  `).join("");return`
    <section class="pt-9 pb-28 text-center bg-[#F4F3F1]">
      ...
      <h2 class="text-3xl text-[#B77449] font-bold mt-2 mb-16">${o.title}</h2>
    ...
    <section id="about" class="py-20">
      <div class="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-start gap-12">
        <div class="md:w-1/3">
          ...
          <h2 class="text-4xl text-[#B77449] font-bold mt-2 mb-8">${s.title}</h2>
  ...
  `}function g(){return`
    <section id="services" class="py-20 bg-gray-50">
      <div class="max-w-6xl mx-auto px-6 text-center mb-16">
        ...
        <h2 class="text-4xl text-[#B77449] font-bold mt-2 mb-8">服務項目</h2>
      </div>
