import{t as i,H as n,F as r}from"./Footer-16fB2aIF.js";function c(){const t=new URLSearchParams(window.location.search).get("id"),e=i.find(l=>l.id===t);if(!e)return`
