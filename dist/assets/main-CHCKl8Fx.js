import{h as a,s as l,c as o,a as e,t as i,b as d,H as n,F as c,d as r,e as x}from"./loading-BcU7SWpk.js";function m(){return`
    <section id="top" class="relative h-[75vh] flex items-center justify-center bg-cover bg-center">
      ...
      <div class="relative z-10 text-center text-white px-4">
        <h1 class="text-shadow-xl text-[14vw] md:text-6xl md:text-6xl font-bold mb-[6vw] md:mb-6 tracking-wider">${a.title}</h1>
        <b class="text-shadow-xl text-lg md:text-xl text-white/90 font-bold">${a.subtitle}</b>
      </div>
    </section>
  `}function p(){const s=l.items.map(t=>`
    <div>
    ...
    <section id="about" class="bg-white py-28 border-b-2 border-[#E0DED8] sm:border-0">
      <div class="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-start gap-12">
        <div class="col-about-title md:w-1/2">
          ...
          <h2 class="tracking-wide text-4xl text-[#B77449] font-bold mt-2 mb-8">${e.title}</h2>
          <p class="tracking-wide text-2xl">${e.subtitle}</p>
        </div>
        <div class="md:w-1/2 text-lg leading-loose ms-auto">
          <p class="mb-6">${e.desc1}</p>
          <p class="mb-10">${e.desc2}</p>
